  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHovered && (
          <div className="pointer-events-none absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-[#090909]/95 px-3 py-1 text-xs text-white ring-1 ring-white/10">
            {label}
          </div>
        )}
      </div>
...
export default function OrbitingSkills() {
  ...
  return (
    <div className="relative flex w-full items-center justify-center overflow-hidden">
      ...
      >
        <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#1a1a1a] to-[#050505] shadow-2xl ring-1 ring-white/10">
          <div className="absolute inset-0 animate-pulse rounded-full bg-cyan-500/30 blur-xl" />
          <div className="absolute inset-0 animate-pulse rounded-full bg-purple-500/20 blur-2xl" style={{ animationDelay: "1s" }} />
